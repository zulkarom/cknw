    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                ...
                <div class="loop-list">
                    @php
                    $editions = get_recent_editions(true, $shortcode->limit ?? 4);
                    @endphp

                    @foreach ($editions as $edition)
                        <article class="row mb-50">
                            {!! Theme::partial('components.edition-simple', ['edition' => $edition]) !!}
                        </article>
                    @endforeach
                </div>
                        ...
                        <div class="widget-taber-content background-white pt-30 pb-30 pl-30 pr-30 border-radius-5">
                            <nav class="tab-nav float-none mb-20">
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link text-uppercase" id="nav-trending-tab" data-bs-toggle="tab"
                                       href="#nav-trending" role="tab" aria-controls="nav-trending"
                                       aria-selected="false">{{ __('Feature') }}</a>
                                    <a class="nav-item nav-link text-uppercase" id="nav-comment-tab" data-bs-toggle="tab"
